...
class Comment(models.Model):
    ...
    replyTo = models.ForeignKey('User', on_delete=PROTECT, null=True, blank=True, related_name="replied_by")
...
class Listing(models.Model):
    ...
    winning_bid = models.DecimalField(max_digits=6, decimal_places=2, null=True, blank=True)
